...
**Ground truths (facts + science only, no narrative):**

| Doc | Holds |
|---|---|
| [`../b2b/pitch-source-of-truth.md`](../b2b/pitch-source-of-truth.md) | Deal facts (✅/🟡/⏳ tagged) |
...
| # | Strategy | File |
|---|---|---|
| 01 | Direct end-investor funnel (unity channel first, belief-ladder design) | [`01-direct-investor-funnel/`](01-direct-investor-funnel/) |

**Archive:** [`_archive/`](_archive/) — pre-greenfield starting points (cold email, video script, fear-branching). Kept for reference; not authoritative, not to be edited or extended.
