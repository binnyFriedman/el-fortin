...
│
├── 📂 03_INVESTOR_CONTRACTS
│   ├── 📄 Reservation_Agreement_Milestones_Template.pdf    [UPLOAD]
...
| Folder | Investor question it answers |
|---|---|
| **01 — Financials** | *"Show me the math — pre-sale arbitrage, yield scenarios, inventory."* |
| **02 — Legal** | *"Is this permitted? Do you own the land? Are flex rights in the deed?"* |
| **03 — Contracts** | *"What happens if you stall or default on the guarantee? Can we step in?"* |
| **04 — Technical** | *"What exactly am I buying — size, spec, furniture, build quality?"* |
...
Document finder fee split in `03_INVESTOR_CONTRACTS/` when template is finalized. Standard practice: fee on signed reservation, not on initial email.
